			...
			<div class="row featurette">
				...
				if (cookies != null){
					...
					for(int i = 0; i < cookies.length; i++){
						tmpCookie = cookies[i];
						if (!( "JSESSIONID".equals(tmpCookie.getName()))) {
							cookieFlag = true;
							if("name".equals(tmpCookie.getName())){
								cookieName = tmpCookie.getValue();
							}
							if("age".equals(tmpCookie.getName())){
								cookieAge = tmpCookie.getValue();
							}
						}
					}// end for
				}// end if
