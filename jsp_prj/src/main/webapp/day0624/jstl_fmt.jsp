 ...
 <div class="row py-lg-1">
  ...
  <div class="album py-5 bg-body-tertiary">
    <div class="container">
      ...
      pageContext.setAttribute("prdList", ps.searchProduct());
      %>
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              가격: <span style="font-weight: bold; "><fmt:formatNumber value="${ prd.price }" pattern="#,###,###"/></span>
              <span style="text-decoration: line-through;"><fmt:formatNumber value="${ prd.price }" pattern="#,###,###"/></span>
              </p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a href="detailPrd.jsp?prdNum=${ prd.prdNum }">
                  <button type="button" class="btn btn-sm btn-secondary">구매하기</button>
                </a>
                </div>
                <small class="text-body-secondary"><fmt:formatDate value="${ prd.inputDate }" pattern="MM-dd-yyyy EEEE a"/></small>
              </div>
            </div>
          </div>
        </div>
