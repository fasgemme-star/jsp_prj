  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<h3>name 속성의 값이 중복되는 HTML Form Control 값 받기</h3>
				<div>
					<%
					//input type="text"는 값이 입력되지 않으면 queryString ""가 생성되고(text=)
					//checkbox는 값이 입력되지 않으면 queryString이 생성되지 않고 null이 입력된다.()
