...
function addText() {
	cnt++;
	$("#txt").append(`<input type="text" name="text" value="테스트${ cnt }">`);
}
</script>
</head>
<body>
		...
		<!-- Wrap the rest of the page in another container to center all the content. -->
			...
			<div class="row featurette">
				...
				<div style="padding-left: 20px">
					<form action="getArrParameterFormProcess.jsp" name="frm" method="GET" id="frm" onsubmit="return false">
						<table>
							<tr>
								<th colspan="2"><h3>name속성의 값이 중복되는 HTML Form Control</h3></th>
							</tr>
							<tr>
								<td>text</td>
								<td>
								<a href="javascript:addText()">추가</a>
								<div id="txt">
