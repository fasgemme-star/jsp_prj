...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d7a50b4496db9d9642ca4f210b982db7"></script>
<script type="text/javascript">
	$(function() {

		var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
		mapOption = {
			center : new kakao.maps.LatLng(37.50460008891598,
					127.05312993437846), // 지도의 중심좌표
			level : 3
		// 지도의 확대 레벨
		};
		...
		// 마커 하나를 지도위에 표시합니다 
		addMarker(new kakao.maps.LatLng(37.50460008891598, 127.05312993437846));
	...
	latlng[0] = [37.50460008891598, 127.05312993437846];
	latlng[1] = [37.50452976485954 , 127.04906972227813];
	latlng[2] = [37.500726619872566 , 127.05119333865554 ];
	latlng[3] = [37.503657948323884 , 127.06345485150085 ];
	latlng[4] = [37.49724206491047 , 127.06478383061719 ];
	
function useMarker(ind){
	hideMarkers();
    var moveLatLon = new kakao.maps.LatLng(latlng[ind][0], latlng[ind][1]);
...
<body>
	...
	<main>
		...
		<input type="button" value="위치보기" id="btn" class="btn btn-sm btn-primary" />
		</div>
		<!-- FOOTER -->
